//! Base JSON-B-compatible command implementation.
...
/// Command event metadata serialized with the Java JSON-B field names.
...
impl AbstractCommand {
    ...
    /// Creates a command with a new event identifier and the current timestamp.
